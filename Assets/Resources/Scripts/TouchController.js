...
function Update()
{
	...
	{		
		...
		if (touchPad.tapCount >= 2) {
		 	...
		 	if(isLeftSide)
		 	{
		 	//if ( touchPad.tapCount >= 2 && touchPad == moveTouchPad )
		 		gameObject.transform.parent.SendMessage ("OnBuildCube", SendMessageOptions.DontRequireReceiver);
		 	}	
	 	}
		...
		if ( jump )
		{
			...
			velocity.y = jumpSpeed;
	 		gameObject.transform.parent.SendMessage ("OnJump", SendMessageOptions.DontRequireReceiver);
